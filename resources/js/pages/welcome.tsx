...
export default function Welcome() {
    ...
    return (
        <>
            ...
            >
                <motion.header variants={item} className="sticky top-6 z-50 mb-6 w-full max-w-[335px] bg-[#FDFDFC] text-sm not-has-[nav]:hidden lg:max-w-4xl dark:bg-[#0a0a0a]">
                ...
                <motion.div variants={item} className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <motion.main variants={item} className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <motion.div
                            variants={item}
                        ...
                        >
                            <motion.h1 variants={item} className="mb-1 font-medium">
                                Let's get started
                            </motion.h1>
                            <motion.p variants={item} className="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                                Laravel has an incredibly rich ecosystem.
                                <br />
                                We suggest starting with the following.
                            </motion.p>
                            <motion.ul variants={item} className="mb-4 flex flex-col lg:mb-6">
                            ...
                            <motion.ul variants={item} className="flex gap-3 text-sm leading-normal">
                                <li>
                                    <a
